<!-- PageFooter="arXiv:2409.01666v1 [cs.CL] 3 Sep 2024" -->
...
<tr>
<td>tayu@nvidia.com</td>
<td>anbangx@nvidia.com</td>
<td>rakkiraju@nvidia.com</td>
</tr>
</table>
...
<figure>
<figcaption>Figure 1: Comparisons between the proposed order- preserve retrieval-augmented generation (OP-RAG) and approaches using long-context LLMs without RAG on En.QA dataset of Bench. Our OP-RAG uses Llama3.1-70B as generator, which significantly outper- forms its counterpart using Llama3.1-70B without RAG.</figcaption>
...
dataset of œBench (Zhang et al., 2024), using only
...
<figure>
<figcaption>Figure 2: Vanilla RAG versus the proposed order- preserve the RAG. As shown in the example, a long document is cropped into 13 chunks, {c;}121. The sim- ilarity score is appended to each chunk. We retrieve top 4 chunks with the highest similarity scores. Vanilla RAG places the chunks in a score-descending order, whereas the proposed order-preserve RAG places the chunks based on the order in the original document.</figcaption>
...
tially and uniformly, {ci}{1. The index i implies
...
<figure>
<figcaption>Figure 3: The influence of context length on the performance of RAG. The evaluations are conducted on En.QA and EN.MC datasets of oBench.</figcaption>
...
dices of top k chunks by J = {ji}} 1. We preserve
...
datasets of oBench (Zhang et al., 2024) bench-
...
<figure>
<figcaption>Figure 4: Comparisons between the proposed order-preserve RAG and vanilla RAG. The evaluations are conducted on En.QA and EN.MC datasets of oBench, using Llama3.1-70B model.</figcaption>
...
<table>
<caption>Table 1: Comparisons among the long-context LLM without RAG, SELF-ROUTE mechanism (Li et al., 2024) and the proposed order-preserve (OP) RAG.</caption>
<tr>
<th rowspan="2">Method</th>
<th colspan="2">EN.QA</th>
<th colspan="2">EN.MC</th>
</tr>
<tr>
<th>F1 Score</th>
<th>Tokens</th>
...
<tr>
<td colspan="5">Long-context LLM w/o RAG</td>
</tr>
<tr>
<td>Llama3.1-70B</td>
<td>34.26</td>
...
<tr>
<td colspan="5">SELF-ROUTE (Li et al., 2024)</td>
</tr>
<tr>
<td>GPT-4O</td>
<td>34.95</td>
...
<tr>
<td colspan="5">Llama3.1-70B order-preserve RAG (ours)</td>
</tr>
<tr>
<td>OP-RAG-16K</td>
<td>44.43</td>
...
Maosong Sun. 2024. oobench: Extending long
