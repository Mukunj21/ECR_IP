...
[Figure: Two-panel bar chart comparing OP-RAG with long-context LLMs. Panel (a) shows F1 score bars for OP-RAG-16K, OP-RAG-24K, OP-RAG-48K, Llama3.1-70B, GPT-4O, and Gemini-1.5-Pro with values labeled above bars; blue bars represent Llama3.1-70B OP-RAG and orange bars represent Long Context. Panel (b) shows average input token count (K) for the same methods, again with blue and orange bars. Caption below identifies Figure 1 as a comparison of proposed order-preserve retrieval-augmented generation (OP-RAG) against long-context LLMs without RAG on En.QA dataset of ∞Bench, using Llama3.1-70B as generator, and notes that OP-RAG significantly outperforms the counterpart without RAG.]
