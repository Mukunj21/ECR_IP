...
```markdown
![Figure: U.S. Environmental Protection Agency Logo]
...
- LCR compliance sampling results collected by the system, as well as justifications for invalidation of LCR samples; and
